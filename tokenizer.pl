...
# /hdd/user15/RNN/new_dataset/train/train.en.txt 
# /hdd/user15/RNN/new_dataset/dev/newstest2013.en
# /hdd/user15/RNN/new_dataset/test/newstest2014.en.txt
# perl tokenizer.pl -l en -time < /hdd/user15/RNN/new_dataset/dev/newstest2013.en > /hdd/user15/RNN/new_dataset2/dev/newstest2013.en
# perl tokenizer.pl -l en -time < /hdd/user15/RNN/new_dataset/test/newstest2014.en.txt > /hdd/user15/RNN/new_dataset2/test/newstest2014.en.txt

# perl tokenizer.pl -l de -time < /hdd/user15/RNN/new_dataset/train/train.de.txt > /hdd/user15/RNN/new_dataset2/train/train.de.txt
# perl tokenizer.pl -l de -time < /hdd/user15/RNN/new_dataset/dev/newstest2013.de > /hdd/user15/RNN/new_dataset2/dev/newstest2013.de
# perl tokenizer.pl -l de -time < /hdd/user15/RNN/new_dataset/test/newstest2014.de.txt > /hdd/user15/RNN/new_dataset/test/newstest2014.de.txt
...
if ($TIMING)
{
    ...
    print STDERR "Processed sentences: $count_sentences\n";
